...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ab: fragment, af: host, am: path, ao: port_, at: protocol, au: query};
	});
...
var $author$project$Main$ID_Invalid = {$: 2};
var $author$project$Main$Load_Failed = {$: 3};
var $author$project$Main$Loading_Cues = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$Loading_YT = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$No = {$: 0};
var $author$project$Main$Received = F3(
	function (a, b, c) {
		return {$: 6, a: a, b: b, c: c};
	});
var $author$project$Main$XML_Invalid = {$: 1};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{U: 1, c: _List_Nil, d: 1, b: 0, aB: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.aB, s.U, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{U: newCol, c: s.c, d: s.d, b: newOffset, aB: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			$elm$parser$Parser$Advanced$AddRight,
			$elm$parser$Parser$Advanced$Empty,
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aB, s.U, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aB, s.U, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $jinjor$elm_xml_parser$XmlParser$DocType = F2(
	function (rootElementName, definition) {
		return {W: definition, aA: rootElementName};
	});
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {U: col, c: context, aB: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {U: s.U, c: newContext, d: s.d, b: s.b, aB: s.aB, a: s.a};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.aB, s0.U, context),
						s0.c),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{U: col, c: s0.c, d: s0.d, b: offset, aB: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aB, s.U, s);
	};
};
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.aB, s.U, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
			...
			case 3:
				...
				if (_v2.$ === 5) {
					...
					if (!result.$) {
						...
						var _v4 = $author$project$Main$parse_xml(fullText);
						if (_v4.$ === 1) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{e: $author$project$Main$XML_Invalid}),
								$elm$core$Platform$Cmd$none);
						} else {
							var cues = _v4.a;
							return _Utils_Tuple2(
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{e: $author$project$Main$Load_Failed}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
					return $author$project$Main$doNothing(model);
						...
						if (!_v10.$) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										e: $author$project$Main$Loading_YT(video_id)
									}),
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{e: $author$project$Main$ID_Invalid}),
								$elm$core$Platform$Cmd$none);
						}
				}
			case 1:
...
var $author$project$Main$common_style_container = _List_fromArray(
	[
		...
		A2($elm$html$Html$Attributes$style, 'padding', '4px 4px 4px 12px')
	]);
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'min-width', '27ch')
				]),
			$author$project$Main$common_style_top),
		_List_Nil);
};
